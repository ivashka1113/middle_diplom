...
const timer = (deadline) => {
    ...
    const calculateClock = () => {
        ...
        timerDaysText = getTime.days.toString().length === 1 ? "0" + getTime.days : getTime.days;
        timerHoursText = getTime.hours.toString().length === 1 ? "0" + getTime.hours : getTime.hours;
        timerMinutesText = getTime.minutes.toString().length === 1 ? "0" + getTime.minutes : getTime.minutes;
        timerSecondsText = getTime.seconds.toString().length === 1 ? "0" + getTime.seconds : getTime.seconds;

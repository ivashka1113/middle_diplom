            ...
            animate({
                ...
                draw(progress) {
                    if (totalValue > oldValue) {
                        totalInput.value = parseFloat((oldValue + (totalValue - oldValue) * progress).toFixed(2));
                    } else if (totalValue < oldValue) {
                        totalInput.value = parseFloat((oldValue - (oldValue - totalValue) * progress).toFixed(2));
                    } else {
